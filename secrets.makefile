...
.PHONY: init tiller-patch ingress ingress-expose kube-lego logging monitoring install
...
secrets.yaml:
	...
	--set cortex.ingress.auth.app.secret=$(AUTH_ING_APP_SECRET) | sed -e '1d' |  sed -e :a -e '$d;N;2,4ba' -e 'P;D' > secrets.yaml
